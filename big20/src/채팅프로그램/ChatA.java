...
//				list.setText(data1);//이렇게하면 인풋에 썻을때 list에 data1을 넣는것 한번만넣어짐
				list.append("A: " + data1 + "\n");// 계속 누적해서 들어감 "\n"은 칸띄워주는거
	...
	public void process() {
		try {
			...
			System.out.println("1. 5000번 port 소켓 생성됨.");
			...
			while (true) { //계속받아올라고
				...
				System.out.println("3. B로부터 받은 데이터: " + new String(data));
